            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                  <p className="text-base font-bold text-blue-800 mb-3">💡 Why Bad Credit <Link href="/terms-conditions" className="text-blue-600 hover:text-blue-800 underline">Terms Conditions</Link> is Destroying Your Financial Future:</p>
                ...
                <div className="text-center bg-yellow-100 border-2 border-yellow-400 rounded-lg p-4">
                  ...
                  <p className="text-base font-medium text-gray-800">Free assessment to see if we can fix your bad credit</p>
