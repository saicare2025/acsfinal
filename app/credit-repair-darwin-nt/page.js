...
export default function CreditRepairCanberraACTPage() {
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="mt-6 space-y-4">
                <p className="text-lg leading-relaxed text-gray-700">
                  Fix Bad Credit Canberra - <a href="/get-credit-repair" className="text-blue-600 hover:text-blue-800 underline">Get Credit Repair</a> Public Service, Parliament & Professional Finance Experts
                </p>
  ...
  <a href="/what-is-a-good-credit-score-australia" className="text-blue-600 hover:text-blue-800 underline">What Is A Good Credit Score Australia</a>                 Yarralumla, or a professional in the Canberra Centre, bad credit shouldn&apos;t limit your capital city
                  dreams.
                </p>
  ...
  <a href="/remove-defaults-from-your-credit-file" className="text-blue-600 hover:text-blue-800 underline">Remove Defaults From Your Credit File</a>                 services Canberra ACT have helped hundreds of government workers, contractors, and professionals
              ...
              <div className="mt-4">
                <p className="text-lg font-semibold text-blue">
                  📞 Call 0489 265 737 <a href="/credit-enquiry-removal" className="text-blue-600 hover:text-blue-800 underline">Credit Enquiry Removal</a> now for your free Canberra credit assessment.
                </p>
              </div>
