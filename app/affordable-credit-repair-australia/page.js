...
export default function AffordableCreditRepairPage() {
  ...
  const structuredData = generateMinimalStructuredData({
    ...
    description:
      "Australia&apos;s most affordable credit repair service. No Win No Fee guarantee, award winning results. Remove defaults fast, fix bad credit for less. 98% success rate, payment plans available.",
    isService: true,
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-slate-900">
            ...
            <div className="w-full lg:w-2/3">
              <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
                ...
                <span className="block mt-2 text-blue">
                  No Win No Fee Award Winners
                </span>
              </h1>

              <div className="mt-6 space-y-4">
                <p className="text-lg leading-relaxed text-gray-700">
                  Think quality credit repair is too expensive? Think again,
                  mate. Australian Credit Solutions delivers award-winning
                  results at prices that won&apos;t break{" "}
                  <a
                  ...
                  the bank. Our No Win No Fee guarantee means you only pay for
                  success – making premium credit repair accessible to every
                  Australian.
                </p>

                <p className="text-base text-gray-600">
                  Award-Winning Results That Won&apos;t Break the Bank. Same
                  award-winning service, same 98% success rate, same qualified
                  lawyers – just at prices ordinary{" "}
                  <a
                  ...
                  Australians can afford. Small admin fee upfront, then you only
                  pay when we remove items. No hidden costs, no ongoing fees, no
                  nasty surprises.
                </p>
              </div>
      ...
      <Section title="Why Centrelink Recipients Struggle with Credit Repair">
        ...
        <p className="mt-6 text-slate-700 font-semibold">
          ...
          Centrelink with{" "}
          <a
            href="/best-credit-cleanup-company-australia"
            className="text-blue-600 hover:text-blue-800 underline"
          >
