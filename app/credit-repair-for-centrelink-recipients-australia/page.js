// File: app/credit-repair-centrelink-recipients/page.jsx
"use client";
...
export default function CentrelinkCreditRepairPage() {
  // FAQ data for structured data
  const faqData = [
    {
      question: "Can I afford credit repair while on Centrelink?",
      answer:
        "Our $330 admin fee is designed to be manageable. We can arrange payment plans over 2-4 weeks if needed. Compare this to what bad credit is costing you in deposits, higher interest rates, and missed opportunities – it pays for itself quickly.",
    },
    {
      question: "Will this affect my Centrelink payments?",
      answer:
        "Absolutely not. Credit repair has no impact on your Centrelink eligibility or payment amounts. We're not changing your income – just cleaning up your credit file so you have better options when you need them.",
    },
    {
      question: "What if you can&apos;t remove anything?",
      answer:
        "If we can&apos;t achieve any removals, you&apos;re only out the $330 admin fee – no additional success fees. But we only take cases where we&apos;re confident of achieving results. Our 98% success rate when we accept cases speaks for itself.",
    },
    {
    ...
    {
      question: "Will credit providers take me seriously if I'm on Centrelink?",
      answer:
        "We handle all communication with credit providers. They respond to our professional disputes based on legal merit, not your employment status. Your Centrelink situation is irrelevant to the validity of credit file disputes.",
    },
  ];

  // Generate structured data for this service page
  const structuredData = generateMinimalStructuredData({
    pathname: "/credit-repair-centrelink-recipients",
    title:
      "Credit Repair for Centrelink Recipients Australia | We Make It Affordable",
    description:
      "Life&apos;s thrown you some curveballs, and now you&apos;re on Centrelink. We get it – and we&apos;re here to help fix your credit without breaking the bank. Affordable, No Win No Fee approach for Centrelink recipients.",
    isService: true,
    serviceType: "Centrelink Credit Repair",
  });
          ...
          <div className="flex flex-col items-center lg:gap-12 lg:flex-row lg:items-start">
            ...
            <div className="w-full lg:w-2/3">
              <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
                Credit Repair for Centrelink Recipients Australia
              ...
              <div className="mt-6 space-y-4">
                ...
                <p className="text-base text-gray-600">
                  At Australian Credit Solutions, we&apos;ve helped hundreds of
                  Centrelink recipients clean up their credit files and get back
                  on track financially. Our affordable,{" "}
                  <strong className="font-semibold text-blue">
                    No Win No Fee
                  </strong>{" "}
                  approach means you won&apos;t pay success fees unless we
                  actually remove the black marks hurting your credit.
                </p>
              </div>
