...
export default function CreditRepairPerthPage() {
  ...
  const faqData = [
    {
      ...
      answer:
        "Our Perth service operates on a No Win No Fee basis. There's a one-off admin fee of $330 (applies regardless of outcome), then success fees only when we remove items. Most Perth clients find the interest rate savings pay for our service within months.",
    },
    {
      question: "How long does credit repair take in Perth?",
      answer:
        "Timeline varies by complexity, but Perth clients typically see results within 2-8 weeks. Urgent cases (property settlements, equipment finance deadlines) often get priority handling.",
    },
    {
      question: "Can you guarantee my defaults will be removed?",
      answer:
        "We only take cases where we're genuinely confident of success. Our 98% success rate means if we accept your Perth case, the odds are heavily in your favour.",
    },
    {
      question: "Do you handle Perth business credit files?",
      answer:
        "Absolutely. Many Perth clients are mining contractors, trade businesses, or FIFO workers with side businesses. We repair both personal and business credit files.",
    },
    {
      question: "What if I'm currently overseas (FIFO mining)?",
      answer:
        "No problem. Everything's handled remotely - phone, email, secure online systems. Many of our Perth clients work overseas rotations. Distance doesn't affect our service quality.",
    },
    {
      question: "Can you help with urgent Perth property purchases?",
      answer:
        "Yes! We offer emergency processing for Perth residents with urgent property finance needs. Same-day assessment, priority handling, and regular updates.",
    },
  ];
  ...
  const structuredData = generateMinimalStructuredData({
    ...
    title:
      "Credit Repair Perth | Fix Bad Credit Fast | Mining Boom Finance Specialists",
    description:
      "Remove defaults, get approved for Perth's property boom. Award-winning specialists with 98% success rate when we take your case. Same-day assessment available. Call 0489 265 737.",
    isService: true,
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-slate-900">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="mt-6 space-y-4">
                <p className="text-lg leading-relaxed text-gray-700">
                  Remove defaults, get approved for Perth&apos;s property boom.{" "}
                  <a
                  ...
                  Award-winning specialists with 98% success rate when we take
                  your case.
                </p>

                <p className="text-base text-gray-600">
                  Fed up with loan rejections? Sick of paying sky-high interest
                  rates{" "}
                  <a
                  ...
                  while watching Perth&apos;s property market boom pass you by?
                  You&apos;re not alone, mate.
                </p>

                <p className="text-base text-gray-600">
                  Bad credit in Perth means missing out on everything - from
                  that dream home in Cottesloe to{" "}
                  <a
                  ...
                  the business loan for your mining services company. But
                  here&apos;s the thing: it doesn&apos;t have to stay that way.
                </p>
                ...
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                  <p className="text-base font-bold text-blue-800 mb-3">
                    ...
                    Residents Choose ACS:
                  </p>
                  <div className="grid grid-cols-2 gap-2 text-base text-blue-700">
                ...
                <div className="text-center bg-yellow-100 border-2 border-yellow-400 rounded-lg p-4">
                  ...
                  <p className="text-base font-medium text-gray-800">
                    Australian Credit Solutions has helped over 3,000 West
                    Australians
                  </p>
                  <p className="text-xs text-gray-600">
                    Ready to join the Perth success stories? Let&apos;s fix your
                    credit file today.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4">
                <p className="text-lg font-semibold text-center text-blue-600">
                  Don&apos;t let bad credit lock you out of Perth&apos;s mining
                  boom!
                </p>
              </div>
      ...
      <RelatedBlock
        currentSlug="/credit-repair-perth"
