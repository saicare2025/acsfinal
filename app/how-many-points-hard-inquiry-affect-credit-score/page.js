// File: app/how-many-points-hard-inquiry-affect-credit-score/page.jsx
"use client";
...
export default function HowManyPointsHardInquiryAffectCreditScorePage() {
  // FAQ data for structured data
  const faqData = [
    {
      question: "How many points does a hard inquiry drop your credit score?",
      answer:
        "A single hard inquiry typically drops your credit score by 2-5 points. However, the impact varies based on your existing credit health - those with poor credit may see larger drops, while those with excellent credit see minimal impact.",
    },
    {
      question: "How long do hard inquiries stay on your credit file in Australia?",
      answer:
        "Hard inquiries remain visible on your Australian credit report for 2 full years. Their impact on your score diminishes over time, with full impact in the first 12 months and reduced impact from 12-24 months.",
    },
    {
      question: "How many hard inquiries are too many?",
      answer:
        "More than 2-3 hard inquiries in 12 months starts to hurt your credit, especially if you have existing credit issues. Multiple inquiries signal &apos;credit seeking behavior&apos; to lenders, even if each individual inquiry only drops your score a few points.",
    },
    {
      question: "Can you remove hard inquiries from your credit file?",
      answer:
        "Only unauthorised or incorrect hard inquiries can be removed from your credit file. Legitimate inquiries from applications you made cannot be removed. However, if you have defaults or late payments, focus on removing those first as they have much greater impact.",
    },
    {
      question: "What hurts your credit score more than hard inquiries?",
      answer:
        "Defaults (50-150 point drops), late payments (10-50 points each), high credit utilisation (50+ points), and court judgments (100+ points) all hurt your score far more than hard inquiries. These should be your priority for credit repair.",
    },
  ];

  // Generate structured data for this service page
  const structuredData = generateMinimalStructuredData({
    pathname: "/how-many-points-hard-inquiry-affect-credit-score",
    title:
      "How Many Points Does a Hard Inquiry Affect Your Credit Score? | Australian Expert Guide",
    description:
      "Hard inquiries drop your credit score 2-5 points, but the real damage runs deeper. Learn what really hurts Australian credit scores and how to fix it fast. Expert guide from award winning specialists.",
    isService: true,
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white text-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center lg:gap-12 lg:flex-row lg:items-start">
            ...
            <div className="w-full lg:w-2/3">
              <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
                ...
                <span className="block mt-2 text-blue">
                  Australian Expert Guide
                </span>
              </h1>

              <div className="mt-6 space-y-4">
                <p className="text-lg leading-relaxed text-gray-700">
                  If you&apos;ve recently applied for a credit card, personal loan, or home loan, you might be wondering: &quot;How many points will this <Link href="/credit-score" className="text-blue-600 hover:text-blue-800 underline">Credit Score</Link> hard inquiry drop my credit score?&quot; It&apos;s a question that keeps many Australians awake at night, especially when they&apos;re already struggling with credit issues.
                </p>

                <p className="text-base text-gray-600">
                  The short answer? A single hard inquiry typically drops your credit score by 2-5 points. But here&apos;s what most people don&apos;t understand - it&apos;s not just about the points. It&apos;s about the bigger picture of your credit health and how{" "}
                  <strong className="font-semibold text-blue">
                    multiple inquiries can create a snowball effect
                  </strong>{" "}
                  that devastates your borrowing power.
                </p>
              </div>
            ...
            <div className="w-full lg:w-1/3 relative">
                      <RelatedBlock currentSlug="/how-many-points-hard-inquiry-affect-credit-score" heading="Related services & guides" />
        <FooterForm
                heading="Get My Free Credit Assessment"
                subheading="Find Out What's Really Hurting Your Score"
                paragraph="Quick credit check: Stop guessing about inquiry points and discover the real issues blocking your financial progress. Our expert team will review your entire credit file."
              />
      ...
      <div className="mx-auto max-w-6xl px-4">
        <Breadcrumb pathname="/how-many-points-hard-inquiry-affect-credit-score" />
      </div>
      ...
      <Section title="Why Centrelink Recipients Struggle with Credit Repair">
        <p className="text-slate-700">
          ...
          understand your <Link href="/blog-details/credit-repair-in-australia-can-help-you-buy-a-home-or-car" className="text-blue-600 hover:text-blue-800 underline">Credit Repair In Australia Can Help You Buy A Home Or Car</Link> situation or want upfront fees you simply can&apos;t
   ...
   <Link href="/blog-details/best-credit-cards-to-build-credit-for-young-adults" className="text-blue-600 hover:text-blue-800 underline">Best Credit Cards To Build Credit For Young Adults</Link>        when it comes to helping Centrelink recipients:
        </p>
        <motion.div
          variants={staggerChildren}
          initial="hidden"
