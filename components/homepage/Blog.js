      ...
      <div className="container max-w-7xl mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Latest{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue to-indigo-600">
              Credit Insights
            </span>
          </h2>
          ...
          >
            {blogPosts.map((post) => (
              <SwiperSlide key={post.id}>
                <motion.div
                  whileHover={{ y: -5 }}
                  className="bg-gradient-to-br from-white to-blue-100 rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-lg transition-all h-full flex flex-col"
