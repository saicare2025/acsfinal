      ...
      <div className="max-w-7xl mx-auto lg:px-4 flex flex-col-reverse lg:flex-row items-center lg:gap-8">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center">
          <motion.div
            ...
            className="w-full max-w-xl bg-white/10 backdrop-blur-lg p-6 sm:p-8 rounded-2xl border border-white/20 shadow-2xl ring-1 ring-blue-900/40"
          >
        ...
        <div className="w-full lg:w-1/2 pt-4 flex items-center justify-center">
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            {/* Approval Badge */}
            <motion.div
              className="absolute -bottom-0 left-0 sm:-left-6 bg-blue-600/90 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg text-xs sm:text-base"
